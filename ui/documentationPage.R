                  ...
                  navlistPanel(
                    tabPanel("Home",
                             ...
                             p(strong("InflammasomeDB"), "is a web database for", strong("accessing and exploring expression data of inflammasome-regulated protein-coding and lncRNA genes."),
                               ...
                               "The database was inspired by and built upon the framework described in", em("Distefano et al., DoxoDB: one-stop-shop for expression analysis of doxorubicin-induced lncRNAs, 2023.")),
                             br(),
                             p("Key features:"),
                             tags$ul(
